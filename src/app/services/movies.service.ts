...
export class MoviesService {
  ...
  private baseUrl:string = 'https://api.themoviedb.org/3/movie/popular?language=es-ES&page=1';
  ...
  constructor(private http: HttpClient) { }
    ...
    getMovies() {
      const headers = new HttpHeaders({
        ...
        Authorization: 'Bearer '+this.API_KEY_READ
      });
    return this.http.get<Movie>(`${this.baseUrl}/popular`, {headers: headers});
  }
}
